 ...
 * @generated */
public class SurgicalMenopauseList_Type extends AnnotationPatternType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = SurgicalMenopauseList.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.SurgicalMenopauseList");
  ...
  public String getConcept(int addr) {
      ...
      jcas.throwFeatMissing("Concept", "gov.va.vinci.menopause.types.SurgicalMenopauseList");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("Date", "gov.va.vinci.menopause.types.SurgicalMenopauseList");
  ...
  public String getRelativeQty(int addr) {
      ...
      jcas.throwFeatMissing("RelativeQty", "gov.va.vinci.menopause.types.SurgicalMenopauseList");
  ...
  public String getRelativeUnit(int addr) {
      ...
      jcas.throwFeatMissing("RelativeUnit", "gov.va.vinci.menopause.types.SurgicalMenopauseList");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public SurgicalMenopauseList_Type(JCas jcas, Type casType) {
    super(jcas, casType);
