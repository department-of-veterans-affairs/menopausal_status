 ...
 * @generated */
public class Date extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  ...
  */  
  ...
  public String getLaterality() {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_Laterality == null)
      jcasType.jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Date");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Date_Type)jcasType).casFeatCode_Laterality);}
  ...
  public void setLaterality(String v) {
    if (Date_Type.featOkTst && ((Date_Type)jcasType).casFeat_Laterality == null)
      jcasType.jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Date");
    jcasType.ll_cas.ll_setStringValue(addr, ((Date_Type)jcasType).casFeatCode_Laterality, v);}    
  }
