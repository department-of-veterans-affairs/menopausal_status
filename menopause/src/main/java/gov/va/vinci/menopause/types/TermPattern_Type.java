...
public class TermPattern_Type extends AnnotationPatternType_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.TermPattern");
  ...
  public String getConcept(int addr) {
      ...
      jcas.throwFeatMissing("Concept", "gov.va.vinci.menopause.types.TermPattern");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("Date", "gov.va.vinci.menopause.types.TermPattern");
  ...
  public String getRelativeQty(int addr) {
      ...
      jcas.throwFeatMissing("RelativeQty", "gov.va.vinci.menopause.types.TermPattern");
  ...
  public String getRelativeUnit(int addr) {
      ...
      jcas.throwFeatMissing("RelativeUnit", "gov.va.vinci.menopause.types.TermPattern");
