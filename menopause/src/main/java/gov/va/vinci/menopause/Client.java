  ...
  public static void main(String[] args) throws CmdLineException {
    if (args.length < 3) {
      new Client(new File("config/ClientConfig.groovy"),
          //new File("config/readers/FileCollectionReaderConfig.groovy"),
            //new File("config/readers/DatabaseCollectionReaderConfig.groovy"),
            new File("config/readers/BatchDatabaseCollectionReaderConfig.groovy"),
            //new File("config/readers/SqlServerPagedDatabaseCollectionReaderConfig.groovy"),
            new File[]{
                    //new File("config/listeners/DatabaseListenerConfig.groovy"),
                    new File("config/listeners/DatabaseListenerConfigDates.groovy")
