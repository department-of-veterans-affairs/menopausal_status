 ...
 * @generated */
public class Symptom_Type extends RegularExpressionType_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.Symptom");
  ...
  public String getLaterality(int addr) {
      ...
      jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Symptom");
