...
public class Exclude_Type extends RegularExpressionType_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.Exclude");
  ...
  public String getLaterality(int addr) {
      ...
      jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Exclude");
