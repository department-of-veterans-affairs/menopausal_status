 ...
 * @generated */
public class MenopauseDiagnosisDate_Type extends AnnotationPatternType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = MenopauseDiagnosisDate.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.MenopauseDiagnosisDate");
  ...
  public String getConcept(int addr) {
      ...
      jcas.throwFeatMissing("Concept", "gov.va.vinci.menopause.types.MenopauseDiagnosisDate");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("Date", "gov.va.vinci.menopause.types.MenopauseDiagnosisDate");
  ...
  public String getRelativeQty(int addr) {
      ...
      jcas.throwFeatMissing("RelativeQty", "gov.va.vinci.menopause.types.MenopauseDiagnosisDate");
  ...
  public String getRelativeUnit(int addr) {
      ...
      jcas.throwFeatMissing("RelativeUnit", "gov.va.vinci.menopause.types.MenopauseDiagnosisDate");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public MenopauseDiagnosisDate_Type(JCas jcas, Type casType) {
    super(jcas, casType);
