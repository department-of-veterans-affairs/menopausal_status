 ...
 * @generated */
public class SurgicalMenopauseDate_Type extends AnnotationPatternType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = SurgicalMenopauseDate.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.SurgicalMenopauseDate");
  ...
  public String getConcept(int addr) {
      ...
      jcas.throwFeatMissing("Concept", "gov.va.vinci.menopause.types.SurgicalMenopauseDate");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("Date", "gov.va.vinci.menopause.types.SurgicalMenopauseDate");
  ...
  public String getRelativeQty(int addr) {
      ...
      jcas.throwFeatMissing("RelativeQty", "gov.va.vinci.menopause.types.SurgicalMenopauseDate");
  ...
  public String getRelativeUnit(int addr) {
      ...
      jcas.throwFeatMissing("RelativeUnit", "gov.va.vinci.menopause.types.SurgicalMenopauseDate");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public SurgicalMenopauseDate_Type(JCas jcas, Type casType) {
    super(jcas, casType);
