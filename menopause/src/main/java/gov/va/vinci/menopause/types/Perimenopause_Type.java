 ...
 * @generated */
public class Perimenopause_Type extends RegularExpressionType_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Perimenopause.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.menopause.types.Perimenopause");
  ...
  public String getLaterality(int addr) {
      ...
      jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Perimenopause");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Perimenopause_Type(JCas jcas, Type casType) {
    super(jcas, casType);
