...
public class Term extends RegularExpressionType {
  ...
  */  
  ...
  public String getLaterality() {
    if (Term_Type.featOkTst && ((Term_Type)jcasType).casFeat_Laterality == null)
      jcasType.jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Term");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Term_Type)jcasType).casFeatCode_Laterality);}
  ...
  public void setLaterality(String v) {
    if (Term_Type.featOkTst && ((Term_Type)jcasType).casFeat_Laterality == null)
      jcasType.jcas.throwFeatMissing("Laterality", "gov.va.vinci.menopause.types.Term");
    jcasType.ll_cas.ll_setStringValue(addr, ((Term_Type)jcasType).casFeatCode_Laterality, v);}    
  }
